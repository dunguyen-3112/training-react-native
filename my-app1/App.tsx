...
import { useCallback, useState, useReducer, useLayoutEffect} from 'react';
import {ActivityIndicator, Button, FlatList, Image, ImageBackground, KeyboardAvoidingView, RefreshControl, SafeAreaView, ScrollView, SectionList, StyleSheet, Switch, Text, TextInput, TouchableOpacity, View } from 'react-native';
        ...
        />
            <ScrollView refreshControl={        
                ...
                <KeyboardAvoidingView 
                    behavior='height'
                >
                    <TouchableOpacity style={{backgroundColor:"#DDDDDD", alignItems:'center', padding:10}}>
